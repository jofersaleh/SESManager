...
xx = Agent10(0, 1000, "Minsoo", "sname")
m = Maneuver(0, 1000, "Simon", "sname")
...
SystemSimulator().get_engine("sname").register_entity(m)
...
SystemSimulator().get_engine("sname").coupling_relation(v, "waypoint", m, "recv")
SystemSimulator().get_engine("sname").coupling_relation(m, "send_result", v, "received")
...
SystemSimulator().get_engine("sname").coupling_relation(x, "waypoint", m, "recv")
SystemSimulator().get_engine("sname").coupling_relation(m, "send_result", x, "received")
...
SystemSimulator().get_engine("sname").coupling_relation(xx, "waypoint", m, "recv")
SystemSimulator().get_engine("sname").coupling_relation(m, "send_result", xx, "received")
